...
# DATABASE_APPS_MAPPING = {'normal': 'default', 'comentarios':'mongo'}
DATABASE_ROUTERS = ['routers.db_routers.ComentariosRouter', 'routers.db_routers.DefaultRouter',]
